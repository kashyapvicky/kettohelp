        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="section-title">
                    <span class="subtitle">GO HERE</span>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-element margin-bottom-30">
                                    <input required type="text" class="input-field" id="first_name" placeholder="User Id*" name="user_name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-element margin-bottom-30">
                                    <input required type="text" class="input-field" id="last_name" placeholder="Password*" name="password">
                                </div>
                            </div>
