...
<body background="<?php echo base_url()?>spinner/images/roullete_image.jpg">
  ...
  <div style="margin-top: 5%; margin-left: 5%">
      <span style="color: red;">Wallet Amount : </span>
      <span id="amount_span" style="color: white;">$<?php echo $wallet_amount; ?></span>
  </div>
  ...
  <div class="control">
    ...
    <div>
      <div id="btnSpin" class="button" style="float: right; margin-top: 50px; background-color:red">Spin</div>

      <input type="number" autocomplete="off"  placeholder="Enter Amount" value="" id="amount" style="margin-top: 62px;margin-left: -40%; background-color: red;
      padding-left:30px; text-decoration-color: red; height: 5vh; width:40%">
