  ...
  <div class="tab-content">
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="index.html">Kettohelp</a>
        <a class="breadcrumb-item" href="index.html">Team</a>
        <span class="breadcrumb-item active">Total Team</span>
      </nav>

      <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5>Achievements</h5>
          <p>Each Donation To Kettohelp Build Your Achievment</p>
        </div><!-- sl-page-title -->

        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Direct Downline</h6>
          <p class="mg-b-20 mg-sm-b-30">Browse Fundraisers. The causes you believe in are all in here.</p>
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                <?php 
                  foreach ($total_team as $key => $value)
                  {
